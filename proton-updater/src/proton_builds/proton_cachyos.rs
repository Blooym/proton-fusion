...
impl ProtonCachyOS {
    pub fn standard() -> Self {
        Self {
            github_repo_name: "proton-cachyos",
            github_repo_owner: "CachyOS",
            proton_entrypoint: "proton",
            proton_release_asset_name: "proton-cachyos",
            proton_release_asset_ext: ".tar.xz",
        }
    }
    ...
    pub fn optimised() -> Self {
        Self {
            ...
            proton_entrypoint: "proton",
            proton_release_asset_name: "proton-cachyos",
            proton_release_asset_ext: "v3.tar.xz",
        }
    }
}

#[async_trait]
impl ProtonBuild for ProtonCachyOS {
    async fn install_or_update(
        ...
        if !entrypoint_exists || current_version != release.tag_name {
            println!(
                "Proton-CachyOS is out of date (current: {current_version}, latest: {}, entrypoint exists: {})",
                release.tag_name, entrypoint_exists
            );
            println!("Downloading new version of Proton-CachyOS");
            ...
            let mut archive = Archive::new(XzDecoder::new(bytes.reader()));
            ...
            println!(
                "Proton-CachyOS was successfully updated to {}",
                release.tag_name
            );
        } else {
            println!("Proton-CachyOS is already up to date")
        }
